...
/**
 * @brief Data for options that depend on a specific value of another option
 */
struct depend_s {
    /**
     * @brief name of option being considered
...
/// temporary pointer for depends before they are combined with hbr depends
...
/// depends array size. used to join version_depends and hbr_depends with memcpy
...
/// pointer to final array of all depends
depend_t *depends;
...
/// depends look-up index generated by arg_hash_generate()
