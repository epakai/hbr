...
static option_t option_v1_0_0[] =
{
    ...
    { "encoder", required_argument, k_string, FALSE, valid_string_set, 13,
        (gchar*[]){"x264", "x264_10bit", "qsv_h264", "x265", "x265_10bit",
            "x265_12bit", "x265_16bit", "qsv_h265", "mpeg4", "mpeg2", "VP8",
            "VP9", "theora"}},
...
static require_t require_v1_0_0[] =
{
...
static conflict_t conflict_v1_0_0[] =
{
    ...
    { "all-audio", NULL, "first-audio", NULL},
